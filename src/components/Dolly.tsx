                ...
                <div className="flex flex-col md:flex-row gap-x-20">
                    ...
                    <div className="">
                        ...
                        <div className='md:text-xl text-sm font-bold '>
                            ...
                            <button className='md:py-2 md:px-6 py-2 px-3 bg-sky-600 rounded-2xl hover:bg-white border-white border my-5 hover:text-black font-bold  md:text-xl'>Reach Out Now</button>
