  ...
  return (
    <section className="py-16 px-4 ">
      <div className=" md:text-center ">
        ...
        <div className="h-2 md:w-[500px] w-[200px] bg-navy md:mx-auto  relative mb-8 mt-2 py-0"/>
            ...
            return (
              <div key={index} className="px-2 py-5 md:p-5  items-center space-y-2 ">
                <div className="flex gap-4 items-center">
                  <div className="h-full *:w-10 *:h-10 *:text-navy">{item.icon}</div>
                  <h3 className="text-2xl md:text-2xl font-bold text-navy">
                    {item.title}
                  </h3>
                </div>
