  ...
  return (
    <section className="py-24 px-4 bg-navy text-white" id="whyus">
      <div className="md:container px-2 mx-auto text-center ">
        ...
        <Link href={"https://wa.me/+19543195224"} className="w-[320px] bg-navy flex justify-center font-medium gap-3 items-center rounded-full py-4 my-10 mx-auto text-xl border-white border-4 border-dotted">
